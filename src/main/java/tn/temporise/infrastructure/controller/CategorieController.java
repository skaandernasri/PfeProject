...
public class CategorieController implements CategoriesApi {
    ...
    @Override
    public ResponseEntity<CategorieResponse> _createCategory(CategorieRequest categorieRequest) throws Exception {
    ...
    @Override
    public ResponseEntity<CategorieResponse> _updateCategory(Long id, CategorieRequest categorieRequest) throws Exception {
